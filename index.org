...
{:deps  {org.clojure/clojurescript        {:mvn/version "1.11.51"}
 ...
 :paths ["src"]
 :aliases
 {:shadow-cljs {:extra-deps {thheller/shadow-cljs {:mvn/version "2.20.20"}
...
{:deps  {org.clojure/clojurescript {:mvn/version "1.11.51"}
 ...
 :paths ["src" "out"]
 :aliases
 {:shadow-cljs {:extra-deps {thheller/shadow-cljs {:mvn/version "2.20.19"}}
                :main-opts  ["-m" "shadow.cljs.devtools.cli"]}
  :build       {:main-opts ["-m" "cljs.main" "-co" "build.edn" "-c"]}
...
**** Build.edn
#+begin_src clojure :tangle babel/build.edn :noweb yes
{:main            reagent-flow.core
 :output-to       "out/reagent_flow.js"
 :output-dir      "out"
 :infer-externs   true
 :npm-deps        false
 ...
 :pseudo-names    true
 :pretty-print    true
 :foreign-libs    [{:file "create-react-class/create-react-class.js"
                   ...
                   {:file "react-dom/cjs/react-dom.development.js"
                    ...
                    :requires ["react" "create-react-class"]}
                   {:file "reactflow/dist/umd/index.js"
                    :provides ["reactflow"]
                    :global-exports {reactflow ReactFlow}
                    :requires ["react" "react-dom" "create-react-class"]}]}
#+end_src
...
npm i
clj -M:shadow-cljs watch examples
#+end_src
...
library will be packed into a jar, shipped to [[https://clojars.org][Clojars]] and the
