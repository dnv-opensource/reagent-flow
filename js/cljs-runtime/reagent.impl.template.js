...
return (function() { 
var G__26175__delegate = function (args){
...
while (G__26176__i < G__26176__a.length) {G__26176__a[G__26176__i] = arguments[G__26176__i + 0]; ++G__26176__i;}
  args = new cljs.core.IndexedSeq(G__26176__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26177);
...
var args = null;
if (arguments.length > 0) {
var G__26179__i = 0, G__26179__a = new Array(arguments.length -  0);
while (G__26179__i < G__26179__a.length) {G__26179__a[G__26179__i] = arguments[G__26179__i + 0]; ++G__26179__i;}
  args = new cljs.core.IndexedSeq(G__26179__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26180);
...
var G__26124 = props;
var G__26124__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26124,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26124);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26124__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26125 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26125,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26125;
}
})(),id_class);
...
var G__26126 = (cljs.core.count(argv) - first_child);
switch (G__26126) {
case (0):
...
var vec__26127 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26127,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26127,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26127,(2),null);
...
var temp__5808__auto___26192 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___26192 == null)){
} else {
var key_26193 = temp__5808__auto___26192;
(jsprops.key = key_26193);
}
...
var temp__5808__auto___26195 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___26195 == null)){
} else {
var key_26197 = temp__5808__auto___26195;
(jsprops.key = key_26197);
}
...
var temp__5808__auto___26202 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___26202 == null)){
} else {
var key_26203 = temp__5808__auto___26202;
(jsprops.key = key_26203);
}
...
var temp__5808__auto___26204 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26204 == null)){
} else {
var key_26205 = temp__5808__auto___26204;
(jsprops.key = key_26205);
}
...
var temp__5808__auto___26206 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26206 == null)){
} else {
var key_26207 = temp__5808__auto___26206;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26141_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26141_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26146 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26146,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26146,(1),null);
...
break;
default:
var G__26217 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26218 = compiler;
v = G__26217;
compiler = G__26218;
continue;
...
var G__26156 = tag;
var G__26156__$1 = (((G__26156 instanceof cljs.core.Keyword))?G__26156.fqn:null);
switch (G__26156__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template26158 = (function (opts,id,fn_to_element,parse_fn,meta26159){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26158.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26160,meta26159__$1){
var self__ = this;
var _26160__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26158(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26159__$1));
}));

(reagent.impl.template.t_reagent$impl$template26158.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26160){
var self__ = this;
var _26160__$1 = this;
return self__.meta26159;
}));

(reagent.impl.template.t_reagent$impl$template26158.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26158.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26158.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26158.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26158.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26158.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26159","meta26159",1217557593,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26158.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26158.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26158");

(reagent.impl.template.t_reagent$impl$template26158.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template26158");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26158.
 */
reagent.impl.template.__GT_t_reagent$impl$template26158 = (function reagent$impl$template$__GT_t_reagent$impl$template26158(opts,id,fn_to_element,parse_fn,meta26159){
return (new reagent.impl.template.t_reagent$impl$template26158(opts,id,fn_to_element,parse_fn,meta26159));
});
...
return (new reagent.impl.template.t_reagent$impl$template26158(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
