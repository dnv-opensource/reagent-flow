...
while (G__26182__i < G__26182__a.length) {G__26182__a[G__26182__i] = arguments[G__26182__i + 0]; ++G__26182__i;}
  args = new cljs.core.IndexedSeq(G__26182__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26183);
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26188__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__26188__delegate.call(this,args);};
...
return G__26188__delegate(args);
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26126 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26126,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26126;
}
})(),id_class);
...
var G__26130 = (cljs.core.count(argv) - first_child);
switch (G__26130) {
case (0):
...
var vec__26134 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26134,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26134,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26134,(2),null);
...
var temp__5808__auto___26202 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___26204 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___26209 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___26209 == null)){
} else {
var key_26214 = temp__5808__auto___26209;
(jsprops.key = key_26214);
}
...
var temp__5808__auto___26221 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26221 == null)){
} else {
var key_26222 = temp__5808__auto___26221;
...
var temp__5808__auto___26223 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26223 == null)){
} else {
var key_26224 = temp__5808__auto___26223;
...
var ctx = ({});
var vec__26152 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26152,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26152,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template26169 = (function (opts,id,fn_to_element,parse_fn,meta26170){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26169.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26171,meta26170__$1){
var self__ = this;
var _26171__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26169(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26170__$1));
}));

(reagent.impl.template.t_reagent$impl$template26169.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26171){
var self__ = this;
var _26171__$1 = this;
return self__.meta26170;
}));

(reagent.impl.template.t_reagent$impl$template26169.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26169.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26169.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26169.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26169.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26169.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26170","meta26170",-2066760449,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26169.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26169.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26169");

(reagent.impl.template.t_reagent$impl$template26169.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template26169");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26169.
 */
reagent.impl.template.__GT_t_reagent$impl$template26169 = (function reagent$impl$template$__GT_t_reagent$impl$template26169(opts,id,fn_to_element,parse_fn,meta26170){
return (new reagent.impl.template.t_reagent$impl$template26169(opts,id,fn_to_element,parse_fn,meta26170));
});
...
return (new reagent.impl.template.t_reagent$impl$template26169(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
