...
var G__25857 = o;
reagent.impl.template.goog$module$goog$object.set(G__25857,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__25876__i = 0, G__25876__a = new Array(arguments.length -  0);
while (G__25876__i < G__25876__a.length) {G__25876__a[G__25876__i] = arguments[G__25876__i + 0]; ++G__25876__i;}
  args = new cljs.core.IndexedSeq(G__25876__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25877);
...
var G__25858 = o;
reagent.impl.template.goog$module$goog$object.set(G__25858,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__25859 = props;
var G__25859__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25859,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25859);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25859__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25860 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25860,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25860;
}
})(),id_class);
...
var vec__25862 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25862,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25862,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25862,(2),null);
...
var temp__5808__auto___25888 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___25888 == null)){
} else {
var key_25889 = temp__5808__auto___25888;
(jsprops.key = key_25889);
}
...
var temp__5808__auto___25890 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___25890 == null)){
} else {
var key_25891 = temp__5808__auto___25890;
...
var temp__5808__auto___25895 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___25895 == null)){
} else {
var key_25897 = temp__5808__auto___25895;
(jsprops.key = key_25897);
}
...
var temp__5808__auto___25899 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___25899 == null)){
} else {
var key_25900 = temp__5808__auto___25899;
(jsprops.key = key_25900);
}
...
var temp__5808__auto___25901 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___25901 == null)){
} else {
var key_25902 = temp__5808__auto___25901;
(jsprops.key = key_25902);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25865_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__25865_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25866 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25866,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25866,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template25872 = (function (opts,id,fn_to_element,parse_fn,meta25873){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25872.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25874,meta25873__$1){
var self__ = this;
var _25874__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25872(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25873__$1));
}));

(reagent.impl.template.t_reagent$impl$template25872.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25874){
var self__ = this;
var _25874__$1 = this;
return self__.meta25873;
}));

(reagent.impl.template.t_reagent$impl$template25872.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25872.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25872.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25872.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25872.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25872.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25873","meta25873",-1073671967,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25872.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25872.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25872");

(reagent.impl.template.t_reagent$impl$template25872.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template25872");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25872.
 */
reagent.impl.template.__GT_t_reagent$impl$template25872 = (function reagent$impl$template$__GT_t_reagent$impl$template25872(opts,id,fn_to_element,parse_fn,meta25873){
return (new reagent.impl.template.t_reagent$impl$template25872(opts,id,fn_to_element,parse_fn,meta25873));
});
...
return (new reagent.impl.template.t_reagent$impl$template25872(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
