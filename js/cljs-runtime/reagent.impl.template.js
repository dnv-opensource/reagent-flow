...
G__26175.cljs$lang$applyTo = (function (arglist__26179){
...
while (G__26183__i < G__26183__a.length) {G__26183__a[G__26183__i] = arguments[G__26183__i + 0]; ++G__26183__i;}
  args = new cljs.core.IndexedSeq(G__26183__a,0,null);
} 
...
var vec__26131 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26131,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26131,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26131,(2),null);
...
var temp__5808__auto___26196 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___26196 == null)){
} else {
var key_26198 = temp__5808__auto___26196;
(jsprops.key = key_26198);
}
...
var temp__5808__auto___26199 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___26199 == null)){
} else {
var key_26200 = temp__5808__auto___26199;
(jsprops.key = key_26200);
}
...
var temp__5808__auto___26213 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26213 == null)){
} else {
var key_26214 = temp__5808__auto___26213;
...
var temp__5808__auto___26215 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26215 == null)){
} else {
var key_26216 = temp__5808__auto___26215;
(jsprops.key = key_26216);
}
...
break;
default:
var G__26228 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26229 = compiler;
v = G__26228;
compiler = G__26229;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template26172 = (function (opts,id,fn_to_element,parse_fn,meta26173){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26172.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26174,meta26173__$1){
var self__ = this;
var _26174__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26172.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26174){
var self__ = this;
var _26174__$1 = this;
return self__.meta26173;
}));

(reagent.impl.template.t_reagent$impl$template26172.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26172.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26172.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26172.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26172.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26172.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26173","meta26173",-215698855,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26172.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26172.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26172");

(reagent.impl.template.t_reagent$impl$template26172.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template26172");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26172.
 */
reagent.impl.template.__GT_t_reagent$impl$template26172 = (function reagent$impl$template$__GT_t_reagent$impl$template26172(opts,id,fn_to_element,parse_fn,meta26173){
