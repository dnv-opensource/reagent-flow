...
var len__5726__auto___25315 = arguments.length;
var i__5727__auto___25316 = (0);
while(true){
if((i__5727__auto___25316 < len__5726__auto___25315)){
args__5732__auto__.push((arguments[i__5727__auto___25316]));

var G__25317 = (i__5727__auto___25316 + (1));
i__5727__auto___25316 = G__25317;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25291){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25296_SHARP_){
return (!((cljs.core.meta(p1__25296_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25299__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25300){var _e__22248__auto__ = e25300;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e25303){var _e__22248__auto__ = e25303;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25309 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25310 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25310);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25311__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25309);
}});
...
var temp__5802__auto___25318 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___25318)){
var managed_print_level_25319 = temp__5802__auto___25318;
var _STAR_print_level_STAR__orig_val__25313_25320 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25314_25321 = managed_print_level_25319;
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25313_25320);
}} else {
job_fn();
}
