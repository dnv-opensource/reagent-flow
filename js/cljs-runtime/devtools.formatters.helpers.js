...
var G__24994 = devtools.prefs.pref(v);
v = G__24994;
continue;
} else {
return v;
...
}catch (e24965){var _e__22371__auto__ = e24965;
return false;
}})();
...
}catch (e24977){var _e__22371__auto__ = e24977;
return false;
}})();
...
}catch (e24979){var _e__22371__auto__ = e24979;
return false;
}}
}
});
...
var vec__24983 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24983,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24983,(1),null);
...
return cljs.core.some((function (p1__24992_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24992_SHARP_);
}),template);
});
