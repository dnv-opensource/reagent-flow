...
var G__25129 = devtools.prefs.pref(v);
v = G__25129;
continue;
} else {
return v;
...
}catch (e25028){var _e__22248__auto__ = e25028;
return false;
}})();
...
}catch (e25030){var _e__22248__auto__ = e25030;
return false;
}})();
...
}catch (e25032){var _e__22248__auto__ = e25032;
return false;
}}
}
});
...
var vec__25057 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25057,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25057,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25077_SHARP_);
}),template);
});
