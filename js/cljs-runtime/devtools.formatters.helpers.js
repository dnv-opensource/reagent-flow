...
var G__25053 = devtools.prefs.pref(v);
v = G__25053;
continue;
} else {
return v;
...
}catch (e24999){var _e__22180__auto__ = e24999;
return false;
}})();
...
}catch (e25001){var _e__22180__auto__ = e25001;
return false;
}})();
...
}catch (e25003){var _e__22180__auto__ = e25003;
return false;
}}
}
});
...
var vec__25019 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25019,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25019,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25028_SHARP_);
}),template);
});
