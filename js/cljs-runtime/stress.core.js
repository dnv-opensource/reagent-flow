...
var sources = cljs.core.some((function (p1__27007_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(source),cljs.core.name(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(p1__27007_SHARP_)))){
...
var temp__5802__auto__ = cljs.core.some((function (p1__27008_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(p1__27008_SHARP_),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(connection__$1))){
...
var expr__27019 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(cljs.core.first(delta)));
if(cljs.core.truth_((pred__27018.cljs$core$IFn$_invoke$arity$2 ? pred__27018.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"remove","remove",-131428414),expr__27019) : pred__27018.call(null, new cljs.core.Keyword(null,"remove","remove",-131428414),expr__27019)))){
...
var handle_init = (function stress$core$main_$_handle_init(p__27021){
var map__27022 = p__27021;
var map__27022__$1 = cljs.core.__destructure_map(map__27022);
var provider = map__27022__$1;
var set_center = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27022__$1,new cljs.core.Keyword(null,"set-center","set-center",-1420039187));
var x = ((200) * (stress.core.cols - (1)));
var y = ((200) * (stress.core.rows - (1)));
var G__27023 = x;
var G__27024 = y;
var G__27025 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zoom","zoom",-1827487038),0.85], null);
...
var vec__27027 = cljs.core.deref(error);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27027,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27027,(1),null);
...
/** @this {Function} */
(stress.core.error_boundary.cljs$lang$applyTo = (function (seq27026){
