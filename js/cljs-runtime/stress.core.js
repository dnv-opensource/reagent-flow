...
var x = ((200) * cljs.core.mod(idx,stress.core.cols));
var y = ((200) * cljs.core.quot(idx,stress.core.cols));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),["edge-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join('')], null),(((idx > (1)))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"source","source",-433931539),["node-",cljs.core.str.cljs$core$IFn$_invoke$arity$1((idx - (1)))].join('')], null):null),(((idx < stress.core.num_nodes))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),["node-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx)].join('')], null):null)], 0));
}),cljs.core.range.cljs$core$IFn$_invoke$arity$2((1),stress.core.num_nodes)));
}
...
var sources = cljs.core.some((function (p1__26687_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(source),cljs.core.name(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(p1__26687_SHARP_)))){
...
var temp__5802__auto__ = cljs.core.some((function (p1__26688_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(p1__26688_SHARP_),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(connection__$1))){
return p1__26688_SHARP_;
} else {
return null;
}
}),connected);
...
var or__5045__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(connection),"sum-node"))?connection:null);
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$1((function (p1__26695_SHARP_){
return stress.core.follow_source(p1__26695_SHARP_,connections);
...
var pred__26704 = cljs.core._EQ_;
var expr__26705 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(cljs.core.first(delta)));
if(cljs.core.truth_((pred__26704.cljs$core$IFn$_invoke$arity$2 ? pred__26704.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"remove","remove",-131428414),expr__26705) : pred__26704.call(null,new cljs.core.Keyword(null,"remove","remove",-131428414),expr__26705)))){
...
var len__5769__auto___26716 = arguments.length;
var i__5770__auto___26717 = (0);
while(true){
if((i__5770__auto___26717 < len__5769__auto___26716)){
args__5775__auto__.push((arguments[i__5770__auto___26717]));

var G__26718 = (i__5770__auto___26717 + (1));
i__5770__auto___26717 = G__26718;
continue;
} else {
}
break;
...
return stress.core.error_boundary.cljs$core$IFn$_invoke$arity$variadic(argseq__5776__auto__);
});
...
var G__26719__delegate = function (children__$1){
...
var vec__26713 = cljs.core.deref(error);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26713,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26713,(1),null);
...
while (G__26720__i < G__26720__a.length) {G__26720__a[G__26720__i] = arguments[G__26720__i + 0]; ++G__26720__i;}
  children__$1 = new cljs.core.IndexedSeq(G__26720__a,0,null);
} 
return G__26719__delegate.call(this,children__$1);};
G__26719.cljs$lang$maxFixedArity = 0;
G__26719.cljs$lang$applyTo = (function (arglist__26721){
var children__$1 = cljs.core.seq(arglist__26721);
return G__26719__delegate(children__$1);
});
...
/** @this {Function} */
(stress.core.error_boundary.cljs$lang$applyTo = (function (seq26712){
