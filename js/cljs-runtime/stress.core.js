...
var sources = cljs.core.some((function (p1__26970_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(source),cljs.core.name(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(p1__26970_SHARP_)))){
...
var temp__5802__auto__ = cljs.core.some((function (p1__26976_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(p1__26976_SHARP_),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(connection__$1))){
return p1__26976_SHARP_;
} else {
return null;
}
}),connected);
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$1((function (p1__26979_SHARP_){
return stress.core.follow_source(p1__26979_SHARP_,connections);
...
var expr__27004 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(cljs.core.first(delta)));
if(cljs.core.truth_((pred__27003.cljs$core$IFn$_invoke$arity$2 ? pred__27003.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"remove","remove",-131428414),expr__27004) : pred__27003.call(null, new cljs.core.Keyword(null,"remove","remove",-131428414),expr__27004)))){
...
var handle_init = (function stress$core$main_$_handle_init(p__27009){
var map__27010 = p__27009;
var map__27010__$1 = cljs.core.__destructure_map(map__27010);
var provider = map__27010__$1;
var set_center = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27010__$1,new cljs.core.Keyword(null,"set-center","set-center",-1420039187));
var x = ((200) * (stress.core.cols - (1)));
var y = ((200) * (stress.core.rows - (1)));
var G__27011 = x;
var G__27012 = y;
var G__27013 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zoom","zoom",-1827487038),0.85], null);
return (set_center.cljs$core$IFn$_invoke$arity$3 ? set_center.cljs$core$IFn$_invoke$arity$3(G__27011,G__27012,G__27013) : set_center.call(null, G__27011,G__27012,G__27013));
});
return (function (){
...
var len__5726__auto___27030 = arguments.length;
var i__5727__auto___27031 = (0);
while(true){
if((i__5727__auto___27031 < len__5726__auto___27030)){
args__5732__auto__.push((arguments[i__5727__auto___27031]));

var G__27032 = (i__5727__auto___27031 + (1));
i__5727__auto___27031 = G__27032;
continue;
} else {
}
break;
...
var G__27033__delegate = function (children__$1){
...
/** @this {Function} */
(stress.core.error_boundary.cljs$lang$applyTo = (function (seq27014){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27014));
}));
