...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26964__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
custom_nodes.core.preview_node = (function custom_nodes$core$preview_node(p__26972){
...
var is_connectable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26973__$1,new cljs.core.Keyword(null,"isConnectable","isConnectable",-187218388));
var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26973__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
var node = reagent_flow.core.get_node_by_id(cljs.core.deref(custom_nodes.core.nodes),id);
...
var len__5726__auto___26995 = arguments.length;
var i__5727__auto___26996 = (0);
while(true){
if((i__5727__auto___26996 < len__5726__auto___26995)){
args__5732__auto__.push((arguments[i__5727__auto___26996]));

var G__26997 = (i__5727__auto___26996 + (1));
i__5727__auto___26996 = G__26997;
continue;
} else {
}
break;
...
var G__26998__delegate = function (children__$1){
...
var vec__26985 = cljs.core.deref(error);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26985,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26985,(1),null);
...
while (G__26999__i < G__26999__a.length) {G__26999__a[G__26999__i] = arguments[G__26999__i + 0]; ++G__26999__i;}
  children__$1 = new cljs.core.IndexedSeq(G__26999__a,0,null);
} 
...
var children__$1 = cljs.core.seq(arglist__27000);
...
/** @this {Function} */
(custom_nodes.core.error_boundary.cljs$lang$applyTo = (function (seq26980){
