...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26012 = c;
var G__26012__$1 = (((G__26012 == null))?null:G__26012.prototype);
if((G__26012__$1 == null)){
return null;
} else {
return G__26012__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26013 = c;
var G__26013__$1 = (((G__26013 == null))?null:G__26013.prototype);
if((G__26013__$1 == null)){
return null;
} else {
return G__26013__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__26072 = c;
var G__26072__$1 = (((G__26072 == null))?null:G__26072.constructor);
if((G__26072__$1 == null)){
return null;
} else {
return G__26072__$1.displayName;
}
})();
...
var G__26075 = c;
var G__26075__$1 = (((G__26075 == null))?null:G__26075.constructor);
if((G__26075__$1 == null)){
return null;
} else {
return G__26075__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__26076 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26077 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26077);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26076);
}});
...
var c = this;
var G__26091_26109 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__26091_26109 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26091_26109);
}
...
var renders_26112 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_26113 = cljs.core.first(cljs.core.vals(renders_26112));
...
if((cljs.core.count(renders_26112) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26112))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26113)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26113], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var _STAR_current_component_STAR__orig_val__26093 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26094 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26094);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26093);
}});
...
var vec__26095 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26095,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26095,(1),null);
...
var G__26098 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__26098 == null)){
return null;
} else {
