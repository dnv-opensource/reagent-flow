...
var o24823 = temp__5802__auto__;
var temp__5802__auto____$1 = (o24823["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o24824 = temp__5802__auto____$1;
return (o24824["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22241__auto__ = f;
return (o__22241__auto__["toString"]).call(o__22241__auto__);
} else {
return "";
}
}catch (e24825){var _ = e24825;
return "";
}});
...
try{var o__22241__auto___25022 = t;
(o__22241__auto___25022["cljs$lang$ctorPrWriter"]).call(o__22241__auto___25022,t,writer);
}catch (e24828){var __25023 = e24828;
}
...
var char_code = (function (){var o__22241__auto__ = (new String(char$));
return (o__22241__auto__["charCodeAt"]).call(o__22241__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22241__auto__ = String;
return (o__22241__auto__["fromCharCode"]).call(o__22241__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24835 = num_code;
switch (G__24835) {
case (1):
return (185);
...
var o__22241__auto__ = String;
return (o__22241__auto__["fromCharCode"]).call(o__22241__auto__,superscript_code);
});
/**
...
}catch (e24844){var _e__22248__auto__ = e24844;
return false;
}})())){
...
var vec__24850 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24850,(0),null);
...
var len__5726__auto___25025 = arguments.length;
var i__5727__auto___25026 = (0);
while(true){
if((i__5727__auto___25026 < len__5726__auto___25025)){
args__5732__auto__.push((arguments[i__5727__auto___25026]));

var G__25027 = (i__5727__auto___25026 + (1));
i__5727__auto___25026 = G__25027;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24868){
var vec__24869 = p__24868;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24869,(0),null);
...
var G__25034 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__25035 = cljs.core.butlast(remaining_tokens);
name_tokens = G__25034;
remaining_tokens = G__25035;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24866){
...
var vec__24875 = cljs.core.split_with((function (p1__24874_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24874_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24875,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24875,(1),null);
...
var vec__24881 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24881,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24881,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__25037 = cljs.core.rest(remaining_tokens);
var G__25038 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__25037;
name_tokens = G__25038;
continue;
} else {
...
var vec__24895 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24895,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24895,(1),null);
var vec__24898 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24898,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24898,(1),null);
var vec__24901 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24901,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24901,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24901,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24901,(3),null);
...
var vec__24936 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24936,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24936,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24936,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24936,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24936,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24936,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__24939 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24939,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24939,(1),null);
var vec__24942 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24942,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24942,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__24945 = cljs.core.second(cljs.core.first(arities));
...
var G__25065 = (arity + (1));
var G__25066 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24954){
var vec__24955 = p__24954;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24955,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24955,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24963_SHARP_){
...
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24964_SHARP_){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24975){
var vec__24976 = p__24975;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24976,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24973){
...
var map__24993 = options;
var map__24993__$1 = cljs.core.__destructure_map(map__24993);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24993__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24993__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24993__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24993__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24994 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(5),null);
...
var o__22241__auto__ = f;
return (o__22241__auto__["getBasis"]).call(o__22241__auto__);
});
/**
...
}catch (e24997){var _e__22248__auto__ = e24997;
...
var G__25118 = (obj[cljs.core.first(path)]);
var G__25119 = cljs.core.rest(path);
obj = G__25118;
path = G__25119;
continue;
} else {
...
var _STAR_ = (function (accum,p__25008){
var vec__25009 = p__25008;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25009,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25009,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25012){
var vec__25013 = p__25012;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25013,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25013,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25013,(2),null);
...
var post_process = (function (p__25017){
var vec__25018 = p__25017;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25018,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25018,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25016_SHARP_){
