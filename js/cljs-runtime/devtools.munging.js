...
var o24777 = temp__5802__auto__;
var temp__5802__auto____$1 = (o24777["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o24778 = temp__5802__auto____$1;
return (o24778["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__22171__auto___24977 = t;
(o__22171__auto___24977["cljs$lang$ctorPrWriter"]).call(o__22171__auto___24977,t,writer);
}catch (e24792){var __24978 = e24792;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24795 = num_code;
switch (G__24795) {
case (1):
return (185);
...
}catch (e24798){var _e__22180__auto__ = e24798;
return false;
}})())){
...
var vec__24800 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(0),null);
...
var len__5726__auto___24988 = arguments.length;
var i__5727__auto___24989 = (0);
while(true){
if((i__5727__auto___24989 < len__5726__auto___24988)){
args__5732__auto__.push((arguments[i__5727__auto___24989]));

var G__24990 = (i__5727__auto___24989 + (1));
i__5727__auto___24989 = G__24990;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24814){
var vec__24815 = p__24814;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24815,(0),null);
...
var G__24993 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__24994 = cljs.core.butlast(remaining_tokens);
name_tokens = G__24993;
remaining_tokens = G__24994;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24807){
...
var vec__24837 = cljs.core.split_with((function (p1__24836_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24836_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24837,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24837,(1),null);
...
var vec__24843 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24843,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24843,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__25005 = cljs.core.rest(remaining_tokens);
var G__25006 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__25005;
name_tokens = G__25006;
continue;
} else {
...
var vec__24852 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24852,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24852,(1),null);
var vec__24855 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24855,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24855,(1),null);
var vec__24858 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24858,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24858,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24858,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24858,(3),null);
...
var vec__24864 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24864,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24864,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24864,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24864,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24864,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24864,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__24873 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24873,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24873,(1),null);
var vec__24876 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24876,(0),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__24879 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__24879) : devtools.munging.parse_fn_info_deep.call(null, G__24879));
})()));
}
} else {
return fn_info;
...
var G__25018 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24888){
var vec__24889 = p__24888;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24889,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24889,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__24900_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24901_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__24901_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___25022 = arguments.length;
var i__5727__auto___25023 = (0);
while(true){
if((i__5727__auto___25023 < len__5726__auto___25022)){
args__5732__auto__.push((arguments[i__5727__auto___25023]));

var G__25024 = (i__5727__auto___25023 + (1));
i__5727__auto___25023 = G__25024;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24912){
var vec__24913 = p__24912;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24913,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24910){
var G__24911 = cljs.core.first(seq24910);
var seq24910__$1 = cljs.core.next(seq24910);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24911,seq24910__$1);
}));
...
var map__24920 = options;
var map__24920__$1 = cljs.core.__destructure_map(map__24920);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24921 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(5),null);
...
}catch (e24924){var _e__22180__auto__ = e24924;
...
var G__25026 = (obj[cljs.core.first(path)]);
var G__25027 = cljs.core.rest(path);
obj = G__25026;
path = G__25027;
continue;
} else {
...
var _STAR_ = (function (accum,p__24936){
var vec__24944 = p__24936;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24944,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24944,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24967){
var vec__24968 = p__24967;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24968,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24968,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24968,(2),null);
...
var post_process = (function (p__24973){
var vec__24974 = p__24973;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24974,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24974,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24972_SHARP_){
return (obj[cljs.core.first(p1__24972_SHARP_)]);
}),sorted_matches);
