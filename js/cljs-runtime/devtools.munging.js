...
var o24882 = temp__5802__auto__;
var temp__5802__auto____$1 = (o24882["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o24883 = temp__5802__auto____$1;
return (o24883["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__22358__auto___24962 = t;
(o__22358__auto___24962["cljs$lang$ctorPrWriter"]).call(o__22358__auto___24962,t,writer);
}catch (e24885){var __24963 = e24885;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24886 = num_code;
switch (G__24886) {
case (1):
return (185);
...
}catch (e24887){var _e__22371__auto__ = e24887;
return false;
}})())){
...
var vec__24888 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24888,(0),null);
...
var len__5769__auto___24966 = arguments.length;
var i__5770__auto___24967 = (0);
while(true){
if((i__5770__auto___24967 < len__5769__auto___24966)){
args__5775__auto__.push((arguments[i__5770__auto___24967]));

var G__24968 = (i__5770__auto___24967 + (1));
i__5770__auto___24967 = G__24968;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24893){
var vec__24894 = p__24893;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24894,(0),null);
...
var G__24969 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__24970 = cljs.core.butlast(remaining_tokens);
name_tokens = G__24969;
remaining_tokens = G__24970;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24891){
...
var vec__24899 = cljs.core.split_with((function (p1__24898_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24898_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24899,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24899,(1),null);
...
var vec__24905 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24905,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24905,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__24972 = cljs.core.rest(remaining_tokens);
var G__24973 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__24972;
name_tokens = G__24973;
continue;
} else {
...
var vec__24910 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24910,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24910,(1),null);
var vec__24913 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24913,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24913,(1),null);
var vec__24916 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24916,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24916,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24916,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24916,(3),null);
...
var vec__24921 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24921,(4),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__24924 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24924,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24924,(1),null);
var vec__24927 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24927,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24927,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__24930 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__24930) : devtools.munging.parse_fn_info_deep.call(null,G__24930));
})()));
}
} else {
return fn_info;
...
var G__24981 = (arity + (1));
var G__24982 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24931){
var vec__24932 = p__24931;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24932,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24932,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24935_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__24935_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24936_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__24936_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24939){
var vec__24940 = p__24939;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24940,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24937){
var G__24938 = cljs.core.first(seq24937);
var seq24937__$1 = cljs.core.next(seq24937);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24938,seq24937__$1);
}));
...
var map__24944 = options;
var map__24944__$1 = cljs.core.__destructure_map(map__24944);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24944__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24944__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24944__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24944__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24945 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(5),null);
...
}catch (e24948){var _e__22371__auto__ = e24948;
...
var G__24990 = (obj[cljs.core.first(path)]);
var G__24991 = cljs.core.rest(path);
obj = G__24990;
path = G__24991;
continue;
} else {
...
var _STAR_ = (function (accum,p__24949){
var vec__24950 = p__24949;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24950,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24950,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24953){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24954,(2),null);
...
var post_process = (function (p__24958){
var vec__24959 = p__24958;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24959,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24959,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24957_SHARP_){
return (obj[cljs.core.first(p1__24957_SHARP_)]);
}),sorted_matches);
