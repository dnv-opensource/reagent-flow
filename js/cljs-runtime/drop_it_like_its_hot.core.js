...
var map__26978 = cljs.core.deref(provider);
var map__26978__$1 = cljs.core.__destructure_map(map__26978);
var screen_to_flow_position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26978__$1,new cljs.core.Keyword(null,"screen-to-flow-position","screen-to-flow-position",1284201580));
var flow_el = flow.state.firstChild;
var rect = flow_el.getBoundingClientRect();
var position = (function (){var G__26979 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),event.clientX,new cljs.core.Keyword(null,"y","y",-1757859776),event.clientY], null);
...
var len__5726__auto___27001 = arguments.length;
var i__5727__auto___27002 = (0);
while(true){
if((i__5727__auto___27002 < len__5726__auto___27001)){
args__5732__auto__.push((arguments[i__5727__auto___27002]));

var G__27003 = (i__5727__auto___27002 + (1));
i__5727__auto___27002 = G__27003;
continue;
} else {
}
break;
...
var G__27004__delegate = function (children__$1){
...
var vec__26992 = cljs.core.deref(error);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26992,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26992,(1),null);
...
while (G__27005__i < G__27005__a.length) {G__27005__a[G__27005__i] = arguments[G__27005__i + 0]; ++G__27005__i;}
  children__$1 = new cljs.core.IndexedSeq(G__27005__a,0,null);
} 
...
var children__$1 = cljs.core.seq(arglist__27006);
...
/** @this {Function} */
(drop_it_like_its_hot.core.error_boundary.cljs$lang$applyTo = (function (seq26988){
