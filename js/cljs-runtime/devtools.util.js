...
var _STAR_print_newline_STAR__orig_val__24332_24531 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__24333_24532 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__24334_24533 = true;
var _STAR_print_fn_STAR__temp_val__24335_24534 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__24334_24533);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__24335_24534);

try{var _STAR_print_level_STAR__orig_val__24337_24535 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__24338_24536 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__24338_24536);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__24337_24535);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__24333_24532);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__24332_24531);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq24326){
...
var new_formatters = current_formatters.filter((function (p1__24444_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__24444_SHARP_)));
}));
...
var G__24473_24561 = f;
var target__22176__auto___24562 = G__24473_24561;
if(cljs.core.truth_(target__22176__auto___24562)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24473_24561)].join(''),"\n","target__22176__auto__"].join('')));
}

(target__22176__auto___24562["toString"] = (function (){
...
var G__24480_24574 = "%c%s";
var G__24481_24575 = "color:transparent";
var G__24482_24576 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__24480_24574,G__24481_24575,G__24482_24576) : f.call(null, G__24480_24574,G__24481_24575,G__24482_24576));
...
var args__5732__auto__ = [];
var len__5726__auto___24577 = arguments.length;
var i__5727__auto___24578 = (0);
while(true){
if((i__5727__auto___24578 < len__5726__auto___24577)){
args__5732__auto__.push((arguments[i__5727__auto___24578]));

var G__24579 = (i__5727__auto___24578 + (1));
i__5727__auto___24578 = G__24579;
continue;
} else {
}
break;
...
var vec__24491 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24491,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24491,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__24584__delegate = function (add_fmt,add_args){
...
var G__24584 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__24585__i = 0, G__24585__a = new Array(arguments.length -  1);
while (G__24585__i < G__24585__a.length) {G__24585__a[G__24585__i] = arguments[G__24585__i + 1]; ++G__24585__i;}
  add_args = new cljs.core.IndexedSeq(G__24585__a,0,null);
} 
return G__24584__delegate.call(this,add_fmt,add_args);};
G__24584.cljs$lang$maxFixedArity = 1;
G__24584.cljs$lang$applyTo = (function (arglist__24587){
var add_fmt = cljs.core.first(arglist__24587);
var add_args = cljs.core.rest(arglist__24587);
return G__24584__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq24485){
...
var G__24488 = cljs.core.first(seq24485__$2);
var seq24485__$3 = cljs.core.next(seq24485__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24486,G__24487,G__24488,seq24485__$3);
}));
...
var seq__24498 = cljs.core.seq(features);
var chunk__24499 = null;
var count__24500 = (0);
var i__24501 = (0);
while(true){
if((i__24501 < count__24500)){
var feature = chunk__24499.cljs$core$IIndexed$_nth$arity$2(null, i__24501);
...
var G__24595 = seq__24498;
var G__24602 = chunk__24499;
var G__24603 = count__24500;
var G__24604 = (i__24501 + (1));
seq__24498 = G__24595;
chunk__24499 = G__24602;
count__24500 = G__24603;
i__24501 = G__24604;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__24498);
if(temp__5804__auto__){
var seq__24498__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__24498__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__24498__$1);
var G__24610 = cljs.core.chunk_rest(seq__24498__$1);
var G__24611 = c__5525__auto__;
var G__24612 = cljs.core.count(c__5525__auto__);
var G__24613 = (0);
seq__24498 = G__24610;
chunk__24499 = G__24611;
count__24500 = G__24612;
i__24501 = G__24613;
continue;
} else {
var feature = cljs.core.first(seq__24498__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null, ).warn(devtools.util.unknown_feature_msg.call(null, feature,known_features,lib_info));
} else {
}
...
var G__24614 = cljs.core.next(seq__24498__$1);
var G__24615 = null;
var G__24616 = (0);
var G__24617 = (0);
seq__24498 = G__24614;
chunk__24499 = G__24615;
count__24500 = G__24616;
i__24501 = G__24617;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o24518 = temp__5802__auto__;
return (o24518["version"]);
} else {
return null;
}
})() == null);
