...
var len__5726__auto___24646 = arguments.length;
var i__5727__auto___24647 = (0);
while(true){
if((i__5727__auto___24647 < len__5726__auto___24646)){
args__5732__auto__.push((arguments[i__5727__auto___24647]));

var G__24648 = (i__5727__auto___24647 + (1));
i__5727__auto___24647 = G__24648;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__24536_24649 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__24537_24650 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__24538_24651 = true;
var _STAR_print_fn_STAR__temp_val__24539_24652 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__24538_24651);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__24539_24652);

try{var _STAR_print_level_STAR__orig_val__24541_24653 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__24542_24654 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__24542_24654);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__24541_24653);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__24537_24650);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__24536_24649);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq24533){
...
var new_formatters = current_formatters.filter((function (p1__24588_SHARP_){
...
var G__24591_24667 = f;
var target__22246__auto___24668 = G__24591_24667;
if(cljs.core.truth_(target__22246__auto___24668)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24591_24667)].join(''),"\n","target__22246__auto__"].join('')));
}

(target__22246__auto___24668["toString"] = (function (){
...
var G__24594_24671 = "%c%s";
var G__24595_24672 = "color:transparent";
var G__24596_24673 = devtools.util.make_detection_printer();
...
var args__5732__auto__ = [];
var len__5726__auto___24674 = arguments.length;
var i__5727__auto___24675 = (0);
while(true){
if((i__5727__auto___24675 < len__5726__auto___24674)){
args__5732__auto__.push((arguments[i__5727__auto___24675]));

var G__24676 = (i__5727__auto___24675 + (1));
i__5727__auto___24675 = G__24676;
continue;
} else {
}
break;
...
var vec__24608 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24608,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24608,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__24677__delegate = function (add_fmt,add_args){
...
var G__24677 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__24678__i = 0, G__24678__a = new Array(arguments.length -  1);
while (G__24678__i < G__24678__a.length) {G__24678__a[G__24678__i] = arguments[G__24678__i + 1]; ++G__24678__i;}
  add_args = new cljs.core.IndexedSeq(G__24678__a,0,null);
} 
...
var add_fmt = cljs.core.first(arglist__24679);
var add_args = cljs.core.rest(arglist__24679);
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq24602){
...
var G__24605 = cljs.core.first(seq24602__$2);
var seq24602__$3 = cljs.core.next(seq24602__$2);
...
var seq__24611 = cljs.core.seq(features);
var chunk__24612 = null;
var count__24613 = (0);
var i__24614 = (0);
while(true){
if((i__24614 < count__24613)){
var feature = chunk__24612.cljs$core$IIndexed$_nth$arity$2(null, i__24614);
...
var G__24680 = seq__24611;
var G__24681 = chunk__24612;
var G__24682 = count__24613;
var G__24683 = (i__24614 + (1));
seq__24611 = G__24680;
chunk__24612 = G__24681;
count__24613 = G__24682;
i__24614 = G__24683;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__24611);
if(temp__5804__auto__){
var seq__24611__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__24611__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__24611__$1);
var G__24684 = cljs.core.chunk_rest(seq__24611__$1);
var G__24685 = c__5525__auto__;
var G__24686 = cljs.core.count(c__5525__auto__);
var G__24687 = (0);
seq__24611 = G__24684;
chunk__24612 = G__24685;
count__24613 = G__24686;
i__24614 = G__24687;
continue;
} else {
var feature = cljs.core.first(seq__24611__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null, ).warn(devtools.util.unknown_feature_msg.call(null, feature,known_features,lib_info));
} else {
}
...
var G__24690 = cljs.core.next(seq__24611__$1);
var G__24691 = null;
var G__24692 = (0);
var G__24693 = (0);
seq__24611 = G__24690;
chunk__24612 = G__24691;
count__24613 = G__24692;
i__24614 = G__24693;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o24641 = temp__5802__auto__;
return (o24641["version"]);
} else {
return null;
}
})() == null);
