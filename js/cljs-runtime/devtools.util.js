...
var len__5726__auto___24408 = arguments.length;
var i__5727__auto___24409 = (0);
while(true){
if((i__5727__auto___24409 < len__5726__auto___24408)){
args__5732__auto__.push((arguments[i__5727__auto___24409]));

var G__24410 = (i__5727__auto___24409 + (1));
i__5727__auto___24409 = G__24410;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__24279_24412 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__24280_24413 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__24281_24414 = true;
var _STAR_print_fn_STAR__temp_val__24282_24415 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__24281_24414);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__24282_24415);

try{var _STAR_print_level_STAR__orig_val__24283_24417 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__24284_24418 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__24284_24418);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__24283_24417);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__24280_24413);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__24279_24412);
}
...
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq24277));
}));
...
var new_formatters = current_formatters.filter((function (p1__24358_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__24358_SHARP_)));
}));
...
var G__24362_24441 = f;
var target__22176__auto___24442 = G__24362_24441;
if(cljs.core.truth_(target__22176__auto___24442)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24362_24441)].join(''),"\n","target__22176__auto__"].join('')));
}

(target__22176__auto___24442["toString"] = (function (){
...
var G__24364_24445 = "%c%s";
var G__24365_24446 = "color:transparent";
var G__24366_24447 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__24364_24445,G__24365_24446,G__24366_24447) : f.call(null, G__24364_24445,G__24365_24446,G__24366_24447));
...
var args__5732__auto__ = [];
var len__5726__auto___24452 = arguments.length;
var i__5727__auto___24453 = (0);
while(true){
if((i__5727__auto___24453 < len__5726__auto___24452)){
args__5732__auto__.push((arguments[i__5727__auto___24453]));

var G__24455 = (i__5727__auto___24453 + (1));
i__5727__auto___24453 = G__24455;
continue;
} else {
}
break;
...
var vec__24376 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24376,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24376,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__24456__delegate = function (add_fmt,add_args){
...
var G__24456 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__24457__i = 0, G__24457__a = new Array(arguments.length -  1);
while (G__24457__i < G__24457__a.length) {G__24457__a[G__24457__i] = arguments[G__24457__i + 1]; ++G__24457__i;}
  add_args = new cljs.core.IndexedSeq(G__24457__a,0,null);
} 
return G__24456__delegate.call(this,add_fmt,add_args);};
G__24456.cljs$lang$maxFixedArity = 1;
G__24456.cljs$lang$applyTo = (function (arglist__24458){
var add_fmt = cljs.core.first(arglist__24458);
var add_args = cljs.core.rest(arglist__24458);
return G__24456__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq24372){
var G__24373 = cljs.core.first(seq24372);
var seq24372__$1 = cljs.core.next(seq24372);
var G__24374 = cljs.core.first(seq24372__$1);
var seq24372__$2 = cljs.core.next(seq24372__$1);
var G__24375 = cljs.core.first(seq24372__$2);
var seq24372__$3 = cljs.core.next(seq24372__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24373,G__24374,G__24375,seq24372__$3);
}));
...
var seq__24383 = cljs.core.seq(features);
var chunk__24384 = null;
var count__24385 = (0);
var i__24386 = (0);
while(true){
if((i__24386 < count__24385)){
var feature = chunk__24384.cljs$core$IIndexed$_nth$arity$2(null, i__24386);
...
var G__24460 = seq__24383;
var G__24461 = chunk__24384;
var G__24462 = count__24385;
var G__24463 = (i__24386 + (1));
seq__24383 = G__24460;
chunk__24384 = G__24461;
count__24385 = G__24462;
i__24386 = G__24463;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__24383);
if(temp__5804__auto__){
var seq__24383__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__24383__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__24383__$1);
var G__24464 = cljs.core.chunk_rest(seq__24383__$1);
var G__24465 = c__5525__auto__;
var G__24466 = cljs.core.count(c__5525__auto__);
var G__24467 = (0);
seq__24383 = G__24464;
chunk__24384 = G__24465;
count__24385 = G__24466;
i__24386 = G__24467;
continue;
} else {
var feature = cljs.core.first(seq__24383__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null, ).warn(devtools.util.unknown_feature_msg.call(null, feature,known_features,lib_info));
} else {
}
...
var G__24468 = cljs.core.next(seq__24383__$1);
var G__24469 = null;
var G__24470 = (0);
var G__24471 = (0);
seq__24383 = G__24468;
chunk__24384 = G__24469;
count__24385 = G__24470;
i__24386 = G__24471;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o24400 = temp__5802__auto__;
return (o24400["version"]);
} else {
return null;
}
})() == null);
