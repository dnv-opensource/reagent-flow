...
}catch (e25636){var _e__22248__auto__ = e25636;
return false;
...
}catch (e25641){var _e__22248__auto__ = e25641;
return false;
...
}catch (e25649){var _e__22248__auto__ = e25649;
return false;
...
}catch (e25651){var _e__22248__auto__ = e25651;
return false;
...
}catch (e25656){var _e__22248__auto__ = e25656;
return false;
}})())){
...
}catch (e25658){var _e__22248__auto__ = e25658;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__25663 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25664 = (function (){var or__5002__auto__ = config;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25664);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null, value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25663);
}});
});
