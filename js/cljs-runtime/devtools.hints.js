...
var map__22530 = top_item;
var map__22530__$1 = cljs.core.__destructure_map(map__22530);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22530__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22530__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22530__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e22529){var _e = e22529;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___22539 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___22539)){
var seen_errors_22540 = temp__5802__auto___22539;
if(cljs.core.truth_(seen_errors_22540.has(self))){
} else {
seen_errors_22540.add(self);

var temp__5804__auto___22541 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___22541)){
var sense_22542 = temp__5804__auto___22541;
