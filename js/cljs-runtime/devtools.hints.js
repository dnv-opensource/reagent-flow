...
}catch (e22311){var _e = e22311;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___22359 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___22359)){
var seen_errors_22362 = temp__5802__auto___22359;
if(cljs.core.truth_(seen_errors_22362.has(self))){
} else {
seen_errors_22362.add(self);

var temp__5804__auto___22363 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___22363)){
var sense_22364 = temp__5804__auto___22363;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22364)].join(''));
} else {
}
}
} else {
